---
title: "Proyecto 2. Diseño de lógica combinacional"
...
2. Desarrolle lo siguiente:
    ...
    3. Dibuje circuitos combinacionales que implementen las funciones lógicas de las tablas a) a e) de la @fig-funciones-logicas. Intente minimizar el uso de recursos para las implementaciones.
    ...
    6. A partir de la @fig-decoder-3x8 que representa la función de un decodificador de código binario natural a código *1 de N* (también llamado decodificador de 3 a 8), dibuje un circuito lo implemente  de manera eficiente.
    7. A partir de la tabla de la @fig-mux-4x1 que representa la función de un multiplexor de 4 a 1, dibuje un circuito que lo implemente de manera eficiente.

![Funciones lógicas](images/harris_fig_2-81.png){#fig-funciones-logicas}

::: {#fig-decoder-3x8 layout-ncol=2}

![](images/decoder-3x8.png){width="180"}
